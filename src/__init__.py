...
from .tasks import multitask_s2s_kplug, sequence_tagging, translation_bertdict
...
from .tasks import translation_with_mask

# BART PLUS
from .tasks.bart_plus import DenoisingPlusTask
